...
Contract.make {
    description "should save new band data"
    request {
        urlPath(value(consumer(regex('/band-data/[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}'))))
        method POST()
        headers {
